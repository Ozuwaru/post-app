...
@endphp
    @foreach ($posts as $post)
        <div class=" post rounded pt-3 pb-3 mx-auto g-0 border-top border-dark"style="background-color: #F0DFBC">
          <div class="row container ">

            <div class="col-2">
              <img src="{{asset('storage/'.$post->imgPath)}}" class="rounded img-fluid" alt="userImg" style="width: 300px; height: 70px; object-fit: cover; object-position: 50% 0;">
            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modifique su comentario</h5>
              ...
              <div class="col-sm-10  py-auto mx-auto">
                ...
                <form action="{{route('saveComment')}}" method="POST">
                  ...
                  <div class="form-group py-2">
                    <input type="text" class="form-control " name="comment" id="comment" placeholder="Ingrese su comentario">
                      @csrf
                    </div>
                  </div>
